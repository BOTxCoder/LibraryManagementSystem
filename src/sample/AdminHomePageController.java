...
public class AdminHomePageController implements Initializable {
    @FXML
    private TableView<ModelTableAdminHome> tableView;
    ...
    ObservableList<ModelTableAdminHome> observableList = FXCollections.observableArrayList();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Maintenanaces.setOnAction((ActionEvent actionEvent)-> {
            SwitchFXML switchFXML = new SwitchFXML();
            try {
